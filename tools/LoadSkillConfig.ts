 ...
 *
 * Or CLI:
 *   bun tools/LoadSkillConfig.ts <skill-dir> <filename>
 */
...
// Constants
const CUSTOMIZATION_DIR = join(getPaiDir(), 'skills', 'PAI', 'USER', 'SKILLCUSTOMIZATIONS');
...
Examples:
  bun LoadSkillConfig.ts skills/PAIUpgrade sources.json
