...
`$PAI_DIR/skills/CORE/USER/SKILLCUSTOMIZATIONS/Evals/`
...
```bash
# Run an eval suite
bun run $PAI_DIR/skills/Evals/Tools/AlgorithmBridge.ts -s <suite>

# Log a failure for later conversion
bun run $PAI_DIR/skills/Evals/Tools/FailureToTask.ts log "description" -c category -s severity

# Convert failures to test tasks
bun run $PAI_DIR/skills/Evals/Tools/FailureToTask.ts convert-all

# Manage suites
bun run $PAI_DIR/skills/Evals/Tools/SuiteManager.ts create <name> -t capability -d "description"
bun run $PAI_DIR/skills/Evals/Tools/SuiteManager.ts list
bun run $PAI_DIR/skills/Evals/Tools/SuiteManager.ts check-saturation <name>
bun run $PAI_DIR/skills/Evals/Tools/SuiteManager.ts graduate <name>
```
...
bun run $PAI_DIR/skills/Evals/Tools/AlgorithmBridge.ts -s regression-core -r 3 -u
```
