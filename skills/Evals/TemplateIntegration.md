...
```
$PAI_DIR/skills/Prompting/Templates/Evals/
...
bun run $PAI_DIR/skills/Prompting/Tools/RenderTemplate.ts \
  -t Evals/Judge.hbs \
  -d $PAI_DIR/skills/Evals/UseCases/<name>/judge-config.yaml \
  -o $PAI_DIR/skills/Evals/UseCases/<name>/judge-prompt.md
```
...
bun run $PAI_DIR/skills/Prompting/Tools/RenderTemplate.ts \
  -t Evals/Rubric.hbs \
  -d $PAI_DIR/skills/Evals/UseCases/<name>/rubric.yaml \
  -o $PAI_DIR/skills/Evals/UseCases/<name>/rubric.md
```
