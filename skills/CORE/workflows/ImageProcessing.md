...
Two main tools available in `skills/CORE/Tools/`:
...
```bash
bun skills/CORE/Tools/RemoveBg.ts image.png output.png
```
...
```bash
bun skills/CORE/Tools/AddBg.ts input.png "#FFFFFF" output.png
```
