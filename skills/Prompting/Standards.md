...
**Location:** `$PAI_DIR/skills/PAI/Tools/fabric/Patterns/`
...
```bash
$PAI_DIR/skills/PAI/Tools/fabric/update-patterns.sh
```
...
All templates live in `$PAI_DIR/skills/Prompting/Templates/`:
...
**CLI Usage:**
```bash
bun $PAI_DIR/skills/Prompting/Tools/RenderTemplate.ts \
