...
**Canonical example to follow:** `$PAI_DIR/skills/_YOURSKILL/SKILL.md`
...
**See:** `$PAI_DIR/skills/PAI/SYSTEM/SKILLSYSTEM.md` (Flat Folder Structure section)
...
**See:** `$PAI_DIR/skills/PAI/SYSTEM/SKILLSYSTEM.md` (Dynamic Loading Pattern section)
