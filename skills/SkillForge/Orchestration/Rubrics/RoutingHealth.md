...
| RH-7 | Canary operation viable | Skill has a RefactorSkill-equivalent workflow that can add/remove workflows | Skill has no workflow management equivalent (acceptable for simple skills) | Workflow management equivalent exists but would fail to maintain routing consistency |
