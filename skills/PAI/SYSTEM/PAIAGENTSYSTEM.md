...
bun run $PAI_DIR/skills/Agents/Tools/AgentFactory.ts --traits "research,enthusiastic,exploratory"
bun run $PAI_DIR/skills/Agents/Tools/AgentFactory.ts --traits "research,skeptical,systematic"
bun run $PAI_DIR/skills/Agents/Tools/AgentFactory.ts --traits "research,analytical,synthesizing"
```
...
- **Delegation Workflow:** `skills/PAI/Workflows/Delegation.md` — Delegation patterns
