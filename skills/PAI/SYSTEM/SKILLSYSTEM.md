...
- Reference `${PAI_DIR}/skills/PAI/USER/` for any personalization
...
- `${PAI_DIR}/skills/PAI/USER/CONTACTS.md` - Contact information
- `${PAI_DIR}/skills/PAI/USER/TECHSTACKPREFERENCES.md` - Tech preferences
```
