...
**Location:** `${PAI_DIR}/skills/PAI/Tools/ToolName.ts`
...
\`\`\`bash
# Basic usage
bun ${PAI_DIR}/skills/PAI/Tools/ToolName.ts [args]

# With options
bun ${PAI_DIR}/skills/PAI/Tools/ToolName.ts --option value
\`\`\`
...
**Location:** `${PAI_DIR}/skills/PAI/Tools/RemoveBg.ts`
...
bun ${PAI_DIR}/skills/PAI/Tools/RemoveBg.ts /path/to/image.png

# Remove background and save to different path
bun ${PAI_DIR}/skills/PAI/Tools/RemoveBg.ts /path/to/input.png /path/to/output.png
```
...
**Location:** `${PAI_DIR}/skills/PAI/Tools/GetTranscript.ts`
...
bun ${PAI_DIR}/skills/PAI/Tools/GetTranscript.ts "https://www.youtube.com/watch?v=VIDEO_ID"

# Save transcript to file
bun ${PAI_DIR}/skills/PAI/Tools/GetTranscript.ts "URL" --save /path/to/transcript.txt
```
...
1. **Add tool file:** Place `.ts` or `.py` file in `${PAI_DIR}/skills/PAI/Tools/`
