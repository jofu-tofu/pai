 ...
 *
 * Usage:
 *   bun run $PAI_DIR/skills/PAI/Tools/SkillSearch.ts <query>
 *   bun run $PAI_DIR/skills/PAI/Tools/SkillSearch.ts "scrape instagram"
 *   bun run $PAI_DIR/skills/PAI/Tools/SkillSearch.ts --list           # List all skills
 *   bun run $PAI_DIR/skills/PAI/Tools/SkillSearch.ts --tier always    # List always-loaded skills
 *   bun run $PAI_DIR/skills/PAI/Tools/SkillSearch.ts --tier deferred  # List deferred skills
 *
...
async function main() {
  ...
  if (!existsSync(INDEX_FILE)) {
    ...
    console.error('   bun run $PAI_DIR/skills/PAI/Tools/GenerateSkillIndex.ts');
    process.exit(1);
  }
