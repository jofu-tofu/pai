...
Comprehensive component architecture and performance optimization guide for React and Next.js applications, designed for AI agents and LLMs. Contains 65 rules across 9 categories: composition patterns for building flexible components (Section 0) and performance optimization from critical (eliminating waterfalls, reducing bundle size) to incremental (advanced patterns). Each rule includes detailed explanations, real-world examples comparing incorrect vs. correct implementations, and specific impact metrics to guide automated refactoring and code generation.

---

## Table of Contents

0. [Component Architecture & Composition](#0-component-architecture--composition) — **HIGH**
   - 0.1 [Avoid Boolean Prop Proliferation](#01-avoid-boolean-prop-proliferation)
   - 0.2 [Use Compound Components](#02-use-compound-components)
   - 0.3 [Decouple State Management from UI](#03-decouple-state-management-from-ui)
   - 0.4 [Define Generic Context Interfaces for Dependency Injection](#04-define-generic-context-interfaces-for-dependency-injection)
   - 0.5 [Lift State into Provider Components](#05-lift-state-into-provider-components)
   - 0.6 [Create Explicit Component Variants](#06-create-explicit-component-variants)
   - 0.7 [Prefer Composing Children Over Render Props](#07-prefer-composing-children-over-render-props)
   - 0.8 [React 19 API Changes](#08-react-19-api-changes)
...
## 0. Component Architecture & Composition
...
### 0.1 Avoid Boolean Prop Proliferation
...
### 0.3 Decouple State Management from UI
...
### 0.4 Define Generic Context Interfaces for Dependency Injection
...
### 0.5 Lift State into Provider Components
...
### 0.6 Create Explicit Component Variants
...
Each variant is explicit about what provider/state it uses, what UI elements it includes, and what actions are available. No boolean prop combinations to reason about. No impossible states.

### 0.7 Prefer Composing Children Over Render Props
