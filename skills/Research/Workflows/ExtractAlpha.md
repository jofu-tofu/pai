...
```bash
$PAI_DIR/History/research/YYYY-MM-DD_description/
```
...
```
$PAI_DIR/History/research/2025-10-26_podcast-analysis/
...
1. **Check if hooks captured the output:**
   ...
   ls -lt $PAI_DIR/History/research/ | head -5

   # Verify your research directory exists
   ls $PAI_DIR/History/research/YYYY-MM-DD_description/
   ```

2. **If hooks did NOT capture automatically:**
   ```bash
   # Create directory structure manually
   mkdir -p $PAI_DIR/History/research/YYYY-MM-DD_description/
...
3. **Confirm all files saved:**
   ```bash
   ls -lah $PAI_DIR/History/research/YYYY-MM-DD_description/
...
mkdir -p $PAI_DIR/History/research/$(date +%Y-%m-%d)_podcast-analysis/
...
ls -lah $PAI_DIR/History/research/$(date +%Y-%m-%d)_podcast-analysis/
...
6. **Save to history** - Final outputs to `$PAI_DIR/History/research/YYYY-MM-DD_description/`
