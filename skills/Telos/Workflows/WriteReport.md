...
cp -r $PAI_DIR/skills/Telos/ReportTemplate/* {output_dir}/
...
```
$PAI_DIR/skills/Telos/ReportTemplate/
```
...
cp ~/Projects/ULSite/public/fonts/*.woff2 $PAI_DIR/skills/Telos/ReportTemplate/public/fonts/
```

**To update template components:**
Edit files in `$PAI_DIR/skills/Telos/ReportTemplate/components/`

**To change color scheme:**
Edit CSS custom properties in `$PAI_DIR/skills/Telos/ReportTemplate/app/globals.css`
