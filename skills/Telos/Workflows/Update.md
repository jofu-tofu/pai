...
TELOS is {principal.name}'s life framework stored in `$PAI_DIR/skills/CORE/USER/TELOS/`. It contains:
...
!`head -50 $PAI_DIR/skills/CORE/USER/TELOS/updates.md`

## View Specific TELOS File
!`FILE="$1"; cat $PAI_DIR/skills/CORE/USER/TELOS/"$FILE"`
...
All backups are stored in: `$PAI_DIR/skills/CORE/USER/TELOS/Backups/`

All changes are logged in: `$PAI_DIR/skills/CORE/USER/TELOS/updates.md`
