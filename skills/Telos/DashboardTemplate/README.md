...
```bash
cp -r $PAI_DIR/skills/Telos/DashboardTemplate /path/to/your/project
...
- Searches `$PAI_DIR/skills/CORE/USER/TELOS/` for `.md` files
- Searches `$PAI_DIR/skills/CORE/USER/TELOS/data/` for `.csv` files
