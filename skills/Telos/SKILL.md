...
1. **Personal TELOS** - {principal.name}'s life context system (beliefs, goals, lessons, wisdom) at `$PAI_DIR/skills/CORE/USER/TELOS/`
...
|--------------|---------|----------|
| "my TELOS", "my goals", "my beliefs", "add to TELOS" | Personal TELOS | `$PAI_DIR/skills/CORE/USER/TELOS/` |
...
```
$PAI_DIR/skills/CORE/USER/TELOS/
```
...
All files located in `$PAI_DIR/skills/CORE/USER/TELOS/`:
...
```bash
# View specific file
read $PAI_DIR/skills/CORE/USER/TELOS/GOALS.md
read $PAI_DIR/skills/CORE/USER/TELOS/BELIEFS.md

# View recent updates
read $PAI_DIR/skills/CORE/USER/TELOS/updates.md
```
...
1. **Dual Context** - Handles both personal and project TELOS seamlessly
   - Personal TELOS: `$PAI_DIR/skills/CORE/USER/TELOS/` (in CORE USER directory)
...
**Remember:** Personal TELOS files live at `$PAI_DIR/skills/CORE/USER/TELOS/` (in the CORE USER directory)
