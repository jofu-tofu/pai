...
PATTERN_PATH="$PAI_DIR/skills/Fabric/Patterns/$PATTERN_NAME/system.md"
...
if [ -f "$PATTERN_PATH" ]; then
  ...
  ls $PAI_DIR/skills/Fabric/Patterns/ | head -20
fi
```
...
**Pattern not found:**
```
Pattern '[name]' not found in $PAI_DIR/skills/Fabric/Patterns/
