...
| Path | Purpose |
|------|---------|
| `$PAI_DIR/skills/Fabric/Patterns/` | Local pattern storage (240+) |
| `$PAI_DIR/skills/Fabric/PatternCatalog.md` | Full pattern documentation |
| `$PAI_DIR/skills/Fabric/Workflows/` | Execution workflows |
| `$PAI_DIR/skills/Fabric/Tools/` | CLI utilities |
