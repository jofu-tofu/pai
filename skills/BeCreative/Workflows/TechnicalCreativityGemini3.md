...
1. Load workflow: `Workflows/TechnicalCreativityGemini3.md`
...
**Dependencies:** This workflow requires the `llm` CLI tool with Gemini 3 Pro access configured. Install via `pip install llm` and configure with `llm keys set gemini`.
