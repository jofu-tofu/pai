...
| Rule | Impact | Summary |
|------|--------|---------|
| [BundleBarrelImports](../../Rules/React/BundleBarrelImports.md) | CRITICAL | Import from specific file paths instead of barrel files to avoid loading entire libraries |
| [BundleDynamicImports](../../Rules/React/BundleDynamicImports.md) | CRITICAL | Use next/dynamic or React.lazy for heavy components not needed on initial render |
| [BundleDeferThirdParty](../../Rules/React/BundleDeferThirdParty.md) | HIGH | Defer non-critical third-party scripts to after page load |
| [BundleConditional](../../Rules/React/BundleConditional.md) | MEDIUM | Load feature code conditionally based on user roles or feature flags |
| [BundlePreload](../../Rules/React/BundlePreload.md) | MEDIUM | Add preload hints for dynamically imported chunks to reduce perceived load time |
