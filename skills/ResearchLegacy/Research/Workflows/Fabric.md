...
`$PAI_DIR/skills/Utilities/Fabric/SKILL.md`
...
1. **Invoke the Fabric skill** - Read and follow `$PAI_DIR/skills/Utilities/Fabric/SKILL.md`
2. **Route to ExecutePattern workflow** - `$PAI_DIR/skills/Utilities/Fabric/Workflows/ExecutePattern.md`
...
**Full documentation:** `$PAI_DIR/skills/Utilities/Fabric/SKILL.md`
