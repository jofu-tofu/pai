...
**Patterns Location:** `$PAI_DIR/skills/Utilities/Fabric/Patterns/`
...
| Path | Purpose |
|------|---------|
| `$PAI_DIR/skills/Utilities/Fabric/Patterns/` | Local pattern storage (240+) |
| `$PAI_DIR/skills/Utilities/Fabric/PatternCatalog.md` | Full pattern documentation |
| `$PAI_DIR/skills/Utilities/Fabric/Workflows/` | Execution workflows |
| `$PAI_DIR/skills/Utilities/Fabric/Tools/` | CLI utilities |
...
### 2026-01-24
- Migrated to PAI Windows (from WSL v2.4)
