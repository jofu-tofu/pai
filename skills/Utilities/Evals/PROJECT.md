...
│   ├── CodeBased/               # Deterministic graders
│   └── ModelBased/              # LLM-powered graders
│
├── Tools/                        # CLI tools
│   ├── AlgorithmBridge.ts       # ALGORITHM integration
│   ├── FailureToTask.ts         # Convert failures to tasks
│   ├── SuiteManager.ts          # Suite management
│   ├── TranscriptCapture.ts     # Capture agent trajectories
│   └── TrialRunner.ts           # Multi-trial execution
│
├── UseCases/                     # Evaluation use cases
...
│   └── DomainPatterns.yaml      # Domain-specific grader configs
│
...
- Use case configs: `UseCases/<name>/config.yaml`
- Test cases: `UseCases/<name>/test-cases/*.json`
- Golden outputs: `UseCases/<name>/golden-outputs/*.md`
- Prompts: `UseCases/<name>/prompts/*.txt`
