...
async function checkActiveProgress(paiDir: string): Promise<string | null> {
  ...
  summary += '\n💡 To resume project: `bun run tools/SessionProgress.ts resume <project>`\n';
  summary += '💡 To complete project: `bun run tools/SessionProgress.ts complete <project>`\n';
...
async function main() {
  try {
    ...
    const isSubagent = claudeProjectDir.includes('/agents/') ||
